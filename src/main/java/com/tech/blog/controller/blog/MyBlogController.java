package com.tech.blog.controller.blog;

import com.tech.blog.controller.vo.BlogDetailVO;
import com.tech.blog.entity.BlogComment;
import com.tech.blog.service.*;
import com.tech.blog.util.*;
...
//        request.setAttribute("newBlogs", blogService.getBlogListForIndexPage(1));
    ...
    public Result comment(HttpServletRequest request, HttpSession session,
        ...
        if (StringUtils.isEmpty(commentator)) {
            return ResultGenerator.genFailResult("请输入名称");
        }
